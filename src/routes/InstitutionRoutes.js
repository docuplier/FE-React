  ...
  return (
    <Suspense fallback={<LoadingAnimation />}>
      <Switch>
        ...
        />
        <PrivateRoute
          path={`${PrivatePaths.INSTITUTIONS}/create-school`}
          exact={true}
          component={RoleSpecificLoader({
        ...
        />
        <PrivateRoute
          path={`${PrivatePaths.INSTITUTIONS}/:institutionId`}
          exact={true}
          component={lazy(() => import('pages/Institutions/FacultyList'))}
        />
        <PrivateRoute
          path={`${PrivatePaths.INSTITUTIONS}/:institutionId/faculties/:facultyId`}
          exact={true}
          component={lazy(() => import('pages/Institutions/Departments'))}
        />
        <PrivateRoute
          path={`${PrivatePaths.INSTITUTIONS}/:institutionId/faculties/:facultyId/departments/:departmentId`}
          exact={true}
          component={lazy(() => import('pages/Institutions/DepartmentDetails'))}
        />
        <PrivateRoute
          path={`${PrivatePaths.INSTITUTIONS}/:institutionId/faculties/:facultyId/departments/:departmentId/levels/:levelId`}
          exact={true}
