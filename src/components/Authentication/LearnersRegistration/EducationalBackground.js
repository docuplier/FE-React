...
const EducationalBackground = ({ handleNextTab, activeTab }) => {
  ...
  return (
    <div className={classes.wrapper}>
      <div className={classes.header}>
        <Typography className="header-text">Educational Background</Typography>
      ...
      {options.length < 1 && (
        <EmptyList
          caption="You currently have no institution registered."
      ...
      <EducationModal setVisibility={setVisibility} visibility={visibility} />
    </div>
  );
};
