...
import DFAUpsertQuestionForm from './DFAUpsertQuestionForm';

const DFAUpsertQuestionFormList = ({ value = [], onChange, deleteQuestion }) => {
  ...
  return (
    <Box>
      ...
      <Box display="flex" justifyContent="flex-end" mt={8} color={'#3CAE5C'}>
        <Button
          color="inherit"
...
DFAUpsertQuestionFormList.propTypes = {
  onChange: PropTypes.func.isRequired,
  value: PropTypes.arrayOf(
    PropTypes.shape({
      ...DFAUpsertQuestionForm.propTypes,
    }),
  ),
...
export default memo(DFAUpsertQuestionFormList);
