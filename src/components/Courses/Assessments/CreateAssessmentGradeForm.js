...
const CreateAssessmentGradeForm = ({ totalObtainableScore, control, errors }) => {
  ...
  return (
    ...
    >
      ...
      <Box mt={8}>
        <Banner severity="info" message={renderBannerMessage()} />
      </Box>
      <Box mt={8}>
        <Controller
          name="passMark"
...
CreateAssessmentGradeForm.propTypes = {
  control: PropTypes.object.isRequired,
  errors: PropTypes.any,
  totalObtainableScore: PropTypes.number.isRequired,
};

export default memo(CreateAssessmentGradeForm);
