...
import { DEFAULT_PAGE_OFFSET, DEFAULT_PAGE_LIMIT, UserRoles, CourseStatus } from 'utils/constants';
              ...
              <Grid item xs={12} sm={3}>
                <Box width={'100%'}>
                  <Box display="flex" justifyContent="flex-end" position="relative">
                    ...
                    >
                      <Typography style={{ paddingLeft: 4 }}>Range</Typography>
                      <CalendarIcon />
                    </Box>
                    {openCalendar && (
                      <Box style={{ position: 'absolute', marginTop: 50 }}>
