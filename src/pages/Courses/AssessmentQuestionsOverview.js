...
const AssessmentQuestionsOverview = () => {
  ...
  return (
    <AssignmentDetailLayout
      links={Links}
      headerText={
        <Typography variant="body2" className={classes.headerText} onClick={() => history.goBack()}>
          <ArrowBackIos /> Back to assessment
        </Typography>
      }
    >
...
export default AssessmentQuestionsOverview;
