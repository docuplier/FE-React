...
import DFAAssignment from 'components/DFACourses/DFACourseDetails/DFAAssignment';
import CourseMoreActions from 'components/Courses/CourseDetails/CourseMoreActions';
import DFALearners from 'components/DFACourses/DFACourseDetails/DFALearners';
...
import InstructorStatsModal from 'components/DFACourses/InstructorStatsModal';
...
import CourseRepOrInstructsList from 'components/DFACourses/DFACourseDetails/DFAInstructorList';
...
import Assessment from 'components/DFACourses/DFACourseDetails/Assessment';
import DFALiveSessions from 'components/DFACourses/DFACourseDetails/DFALiveSessions';

const breadCrumbs = [
  { title: 'Home', to: '/dfa-assessment-dashboard' },
  { title: 'Course', to: PrivatePaths.DFA_COURSE_DETAILS },
];
...
const DFACourseDetails = () => {
  ...
  const courseId = '11e2f48d-21fa-4b46-b908-147b916df76b';
  ...
  const handleChangeTab = (tabIndex) => {
    ...
    history.push(`${PrivatePaths.DFA_COURSE_DETAILS}/${courseId}?tab=${tabValue}`);
  };
      ...
      <Box>
        ...
        <Box className={classes.metaDataContainer}>
          ...
          <Box display="flex" alignItems="center" mt={isSmallScreen ? 5 : 0}>
            ...
            <Chip label="Lead instructor" color="active" roundness="lg" />
          </Box>
        </Box>
        <AccessControl allowedRoles={[UserRoles.STUDENT]}>
  ...
  const renderContent = () => {
    switch (currentTabValue) {
      ...
      case Tabs.assignments.value:
        return <DFAAssignment course={course} />;
      ...
      case Tabs.learners.value:
        return <DFALearners course={course} />;
      case Tabs.liveSession.value:
        return <DFALiveSessions course={course} />;
      default:
        return <About course={course} />;
    }
  };
  ...
  const description =
    'Explain who is here, lorem ipsum dolor amet connecteur. Explain who is here, lorem ipsum dolor amet connecteur. Explain who is here, lorem ips.';
...
export default DFACourseDetails;
