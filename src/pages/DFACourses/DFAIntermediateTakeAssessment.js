...
import DFAIntermediateAssessment from 'components/DFAAssessment/DFAIntermediateAssessmtTake/DFAIntermediateAssessment';
...
const DFAIntermediateTakeAssessment = () => {
    ...
    return (
      <Box component={Paper} className={classes.description} square>
        ...
        <Box className={classes.wrapper}>
          {/* <img src={Confetti} alt="confetti-gif" style={{ width: '20%' }} /> */}
          <img src={Congrats} alt="congrats" style={{ width: '20%' }} />
          <Typography className={classes.title}>Congratulations {userName}!</Typography>
          <Typography className={classes.text}>
            Congratulations on completing this assessment! Your commitment to learning is truly
            impressive. Your results will help us ensure you receive the best learning experience.
          </Typography>
...
export default React.memo(DFAIntermediateTakeAssessment);
