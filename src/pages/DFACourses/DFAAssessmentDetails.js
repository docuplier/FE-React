...
const DFAAssessmentDetails = () => {
  ...
  const routeToEditAssessment = () => {
    if (isGlobalAssessment) {
      return history.push(`${PrivatePaths.DFA_ASSESSMENTS}/create-assessment?id=${assessmentId}`);
    } else {
      return history.push(
  ...
  const breadCrumbs = useMemo(
    () =>
      [
        { title: 'Home', to: isGlobalAssessment ? '/dfa-assessments' : '/' },
...
export default DFAAssessmentDetails;
