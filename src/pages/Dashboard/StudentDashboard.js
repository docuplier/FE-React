  ...
  const handleNavigationForStudent = ({
    ...
    switch (completionStatus) {
      case AssessmentCompletionStatus.COMPLETED:
        return `${PrivatePaths.ASSESSMENTS}/${assessmentId}/assessment-submissions`;
      case AssessmentCompletionStatus.PENDING:
        return `${PrivatePaths.ASSESSMENTS}/${assessmentId}/start-assessment`;
      default:
        if (
          isCurrentTimeWithinAssessmentDateRange({ startDate, startTime, dueDate, dueTime }).value
        ) {
          return `${PrivatePaths.ASSESSMENTS}/${assessmentId}/take-assessment`;
        }
        return `${PrivatePaths.ASSESSMENTS}/${assessmentId}/assessment-submissions`;
    }
  };
