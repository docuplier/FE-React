...
import DFAActivityLogLayout from 'Layout/DFALayout/DFAActivityLogLayout';
...
const DFAHomePage = () => {
  ...
  const columns = [
...

    {
      ...
      render: (activityType) => (
        <Typography>{convertUnderscoreToTitleCase(activityType)}</Typography>
      ),
      sorter: true,
    },
    {
  ...
  return (
    <>
      <DFAActivityLogLayout isLoading={loading}>
            ...
            <Paper className={classes.headBody}>
              ...
              <MaxWidthContainer spacing={'sm'}>
                ...
                <ResourceTable
                  ...
                  onChangeSort={(_order, property) =>
                    handleChangeQueryParams({ ordering: property })
                  }
                  pagination={{
